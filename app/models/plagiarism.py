...
class PlagiarismCheck(Base, TimestampMixin):
    ...
    check_document_id = Column(Integer, ForeignKey("check_documents.id"), nullable=False)
    ...
    check_document = relationship("CheckDocument", back_populates="plagiarism_checks")
